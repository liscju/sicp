; picture language code taken from https://gist.github.com/etscrivner/e0105d9f608b00943a49 
#lang racket/gui
...
(define (split painttransf1 painttransf2)
  (define recursive-split
    (lambda (painter n)
      (if (= n 0)
          painter
          (let ((smaller (recursive-split painter (- n 1))))
            (painttransf1 painter (painttransf2 smaller smaller))))))
  recursive-split)
...
((right-split wave-painter 4) unit-frame)
