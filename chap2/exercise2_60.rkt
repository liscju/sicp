...
; complexity of element-of-set? can increase many times
; because each element can be in list multiple times
...
; O(1) is much less than original O(n)

(equal? (adjoin-set 5 (list)) (list 5))
(equal? (adjoin-set 5 (list 1)) (list 5 1))
(equal? (adjoin-set 5 (list 5)) (list 5 5))
(equal? (adjoin-set 5 (list 5 3 2)) (list 5 5 3 2))
(equal? (adjoin-set 5 (list 2 5 3)) (list 5 2 5 3))
(equal? (adjoin-set 5 (list 2 3 5)) (list 5 2 3 5))
...
; complexity of intersection-set can increase because there is more elements
; to search for intersection
...
(equal? (union-set (list 1 2) (list 1 2)) (list 1 2 1 2))
(equal? (union-set (list 1 2 3) (list 4 1 5)) (list 1 2 3 4 1 5))
(equal? (union-set (list 1 2 3) (list 4 2 5)) (list 1 2 3 4 2 5))
(equal? (union-set (list 1 2 3) (list 3 4 5)) (list 1 2 3 3 4 5))
(equal? (union-set (list 1 2 3 4 5) (list 1 6 3 7 5)) (list 1 2 3 4 5 1 6 3 7 5))

; union of two sets is O(1) which is much less than in orignal version